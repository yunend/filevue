...
1. Native Windows Installation:
   - Download zip package: [fileVue-win-x64.zip](https://github.com/yunend/filevue/releases/download/v2.1.0/fileVue-win-x64.zip)
...
## Online Demo
Visit our demo site: [http:yunend.top](http://yunend.top)
